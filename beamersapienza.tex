...
\vspace{\baselineskip}
 ...
 style adaptation contributed by Kian Chen
...
\begin{itemize}
\item Enough for \cite{WOS:000329809100028}
an introduction! You should know enough by now
...
\begin{frame}
      ...
      \begin{thebibliography}{10}
            ...
            \bibitem{WOS:000329809100028}
            Tim S. From Sihanouk to Pol Pot: Diplomacy, Human Rights, and Relations between the Federal Republic of Germany and Cambodia, 1967–1979[J]. German Yearbook of Contemporary History,2022,2(1).
      \end{thebibliography}
\end{frame}
